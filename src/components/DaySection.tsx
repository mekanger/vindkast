              ...
              {isLoading ? (
                ...
                <div className="mt-2">
                  ...
                  <div className="grid grid-cols-5 gap-2 items-center mb-1">
                    <div className="text-xs text-muted-foreground font-medium">Vind</div>
                    {DISPLAY_HOURS.map((hour) => {
                  ...
                  {/* Gust row */}
                  <div className="grid grid-cols-5 gap-2 items-center mb-1">
                    <div className="text-xs text-muted-foreground font-medium">Vindkast</div>
                    {DISPLAY_HOURS.map((hour) => {
                      const hourForecast = forecast.forecasts.find(f => f.hour === hour);
                      return (
                  ...
                  {forecast.forecasts.some(f => f.seaCurrentSpeed != null) && (
                    <div className="grid grid-cols-5 gap-2 items-center">
                      <div className="text-xs text-muted-foreground font-medium">Havstrøm</div>
                      {DISPLAY_HOURS.map((hour) => {
                        const hourForecast = forecast.forecasts.find(f => f.hour === hour);
                        return (
                          <div key={hour} className="text-center">
